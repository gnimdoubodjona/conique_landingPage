...
export default function Processus() {
  return (
    <section className="bg-white px-8 md:px-16 lg:px-32 py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 max-w-2xl">
          ...
          <h2 className="font-black text-black leading-none tracking-tight" style={{ fontSize: "clamp(2.6rem, 5vw, 4.5rem)" }}>
            ...
            return (
              <div
                ...
                className={`relative flex flex-col p-8 bg-white group cursor-default transition-colors duration-200 hover:bg-zinc-50
                  ${!isLast ? "border-b-2 lg:border-b-0 lg:border-r-2 border-black" : ""}
                `}
              >
                ...
                <p
                  ...
                  style={{ color: LIME, WebkitTextStroke: `1px ${PURPLE}`, color: PURPLE }}
                >
                  Étape {step.number}
                </p>
        ...
        {/* ── BOTTOM STATEMENT ── */}
        <div className="border-2 border-t-0 border-black flex flex-col md:flex-row items-center justify-between px-8 py-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-500 text-sm font-medium">Disponible pour de nouveaux projets</span>
          </div>
        </div>
